...
class RastvorovKRunFuncTestsProcesses
...
const std::array<TestType, 5> kTestParam = {
    ...
    std::make_tuple(25, "n25"),
};

const auto kTestTasksList =
    std::tuple_cat(
        ppc::util::AddFuncTask<RastvorovKNumberAfCharacterAlternationsMPI, InType>(
...
const auto kTestName =
    RastvorovKRunFuncTestsProcesses::PrintFuncTestName<RastvorovKRunFuncTestsProcesses>;

INSTANTIATE_TEST_SUITE_P(AlternationsFuncTests,
                         RastvorovKRunFuncTestsProcesses,
                         kGtestValues,
                         kTestName);
